...
module.exports = async(email) =>{  
            ...
            const info = await transporter.sendMail({
                ...
                <div style="width: 100%; padding: 5%; overflow: hidden;">
                  ...
                  <div style="padding: 30px; background-color: #f4f4f4; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <a href="https://stellular-twilight-ebcd7d.netlify.app/verify-user?email=${email}" style="display: inline-block; padding: 20px; background-color: #e8491d; color: #fff; text-decoration: none; border-radius: 5px; font-size: 18px;">Verify Email</a>
    ...
    // https://main--stellular-twilight-ebcd7d.netlify.app